#ifndef CAFFE_WEIGHTED_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_WEIGHTED_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
class WeightedCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
  explicit WeightedCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "WeightedCrossEntropyLoss"; }
 ...
 protected:
  ...
  vector<float> dim_weight_;
};

}  // namespace caffe

#endif  // CAFFE_WEIGHTED_CROSS_ENTROPY_LOSS_LAYER_HPP_
